		...
		<>
			...
			<div className="slider-thumnail">
				<Slider {...settingsThumbs} ref={slider2} className="slider-nav-thumbnails">
					<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb.png" alt="Wenago" /></div>
					<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb2.png" alt="Wenago" /></div>
					<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb3.png" alt="Wenago" /></div>
					<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb.png" alt="Wenago" /></div>
				</Slider>
			</div>
		</>
