			...
			<Swiper {...swiperGroup8}>
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/eiffel-tower.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/MachuPicchu.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GreatWall.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/StatueofLiberty.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/TajMahal.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/OperaHouse.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/Colosseum.png" alt="Wenago" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GrandCanyon.png" alt="Wenago" /></div>
