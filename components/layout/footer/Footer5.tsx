                    ...
                    <div className="row">
                        <div className="col-md-3 col-sm-12 footer-1">
                            <div className="mt-20 mb-20">
                                <a className="d-inline-block mb-20" href="/" style={{ textDecoration: 'none' }}>
                                    <span style={{ fontWeight: 800, fontSize: 32, letterSpacing: '-0.02em', color: '#fff' }}>wenagoo</span>
                                </a>
                                ...
                                <div className="box-need-help">
                                    ...
                                    <br />
                                    <a className="heading-6 phone-support" href="tel:1-800-222-8888">
                                        1-800-222-8888
                                    </a>
                                </div>
                            </div>
