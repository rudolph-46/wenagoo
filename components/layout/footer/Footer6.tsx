                            ...
                            <div className="col-lg-3 col-sm-12">
                                <div className="mt-20 mb-20">
                                    <a className="d-inline-block mb-20" href="index.html">
                                        <img alt="Wenago" src="assets/imgs/template/logo-footer.svg" />
                                    </a>
                                    <div className="box-info-contact mt-0">
                                        <p className="text-md color-white">Dive into local recommendations for a truly authentic experience.</p>
                                    </div>
