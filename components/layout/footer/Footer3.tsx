                    ...
                    <div className="container-footer">
                        <div className="row">
                            <div className="col-lg-3 col-sm-12">
                                <div className="mt-20 mb-20"><Link className="d-inline-block mb-20" href="/"><img className="dark-mode" alt="Wenago" src="/assets/imgs/template/logo-footer.svg" /><img className="light-mode" alt="Wenago" src="/assets/imgs/template/logo-footer-w.svg" /></Link>
                        ...
                        <div className="footer-bottom mt-50">
                            <div className="row align-items-center">
                                <div className="col-md-6 text-md-start text-center mb-20">
                                    <p className="text-sm neutral-1000">© {new Date().getFullYear()} Wenago Inc. All rights reserved.</p>
                                </div>
