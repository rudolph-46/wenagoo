        ...
        <>
            <footer className="footer footer-type-3 background-body">
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 mb-30"> <Link className="d-inline-block mb-20" href="/"><img className="light-mode" alt="Wenago" src="/assets/imgs/template/logo-footer2.svg" /><img className="dark-mode" alt="Wenago" src="/assets/imgs/template/logo-footer.svg" /></Link>
