                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-sm-12">
                            <div className="mb-20"><Link className="d-inline-block mb-20" href="/"><img alt="Wenago" src="/assets/imgs/template/logo-footer.svg" /></Link>
                                <div className="box-info-contact mt-0">
                                    ...
                                    <p className="text-md neutral-400 icon-email">support@wenago.com</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="box-footer-col-3">
                        <div className="footer-col-1">
                            <div className="box-footer-help"><img alt="Wenago" src="/assets/imgs/page/homepage6/help.svg" />
                        ...
                        <div className="footer-col-2">
                            <div className="box-join"><img alt="Wenago" src="/assets/imgs/page/homepage6/join.svg" /><span className="text-xl-bold">Join Wenago Affiliate Program Today !</span></div>
                        </div>
                        <div className="footer-col-3">
                            <div className="box-send-message"> <img alt="Wenago" src="/assets/imgs/page/homepage6/msg.svg" />
