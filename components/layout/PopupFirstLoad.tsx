                ...
                <div className="popup-container">
                    <div className="popup-content"> <a className="close-popup" />
                        <div className="popup-left">
                            <div className="logo-area"> <img className="light-mode" alt="Wenago" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="Wenago" src="/assets/imgs/template/logo-w.svg" /></div>
                        ...
                        <div className="popup-right">
                            ...
                            </div><img alt="Wenago" src="/assets/imgs/template/img-popup.png" />
