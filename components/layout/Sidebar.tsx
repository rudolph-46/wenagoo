			...
			<div className={`sidebar-canvas-wrapper perfect-scrollbar button-bg-2 ${isSidebar ? "sidebar-canvas-visible" : ""}`}>
				<PerfectScrollbar className="sidebar-canvas-container">
					<div className="sidebar-canvas-head">
						<div className="sidebar-canvas-logo"> <Link className="d-flex" href="/"><img className="light-mode" alt="Wenago" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="Wenago" src="/assets/imgs/template/logo-w.svg" /></Link></div>
						<div className="sidebar-canvas-lang">
							<LanguageDropdown />
							<CurrencyDropdown />
							<a className="close-canvas" onClick={handleSidebar}> <img alt="Wenago" src="/assets/imgs/template/icons/close.png" /></a>
						</div>
					...
					<div className="sidebar-canvas-content">
						...
						<div className="box-quicklinks">
							...
							<div className="box-list-quicklinks">
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/notify.svg" alt="Wenago" />
									</div>
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/bookmark.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/wallet.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/discount.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/friends.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/tickets.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
								...
								<div className="item-quicklinks">
									<div className="item-icon"> <img src="/assets/imgs/template/icons/settings.svg" alt="Wenago" />
									</div>
									<div className="item-info"> <Link href="#">
						...
						<div className="box-savedplaces">
							...
							<div className="box-list-places">
								<div className="card-place">
									<div className="card-image"> <img src="/assets/imgs/page/homepage1/place.png" alt="Wenago" />
									</div>
									<div className="card-info background-card">
										<div className="card-info-top">
											<h6 className="text-xl-bold"> <Link className="neutral-1000" href="#">Machu Picchu</Link></h6>
											<p className="text-xs card-rate"> <img src="/assets/imgs/template/icons/star.svg" alt="Wenago" />4/5</p>
										</div>
								...
								<div className="card-place">
									<div className="card-image"> <img src="/assets/imgs/page/homepage1/place2.png" alt="Wenago" />
									</div>
									<div className="card-info background-card">
										<div className="card-info-top">
											<h6 className="text-xl-bold"> <Link className="neutral-1000" href="#">Machu Picchu</Link></h6>
								...
								<div className="card-place">
									<div className="card-image"> <img src="/assets/imgs/page/homepage1/place3.png" alt="Wenago" />
									</div>
									<div className="card-info background-card">
										<div className="card-info-top">
											<h6 className="text-xl-bold"> <Link className="neutral-1000" href="#">Machu Picchu</Link></h6>
						...
						<div className="box-contactus">
							...
							<div className="contact-info">
								...
								<p className="email-2 text-md-medium neutral-1000">support@wenago.com</p>
							</div>
						</div>
					</div>
				</PerfectScrollbar>
