                ...
                <div className="box-love-us-inner">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-5 wow fadeInLeft"><img src="/assets/imgs/page/homepage3/img-love.png" alt="Wenago" /></div>
                            <div className="col-lg-7 wow fadeInRight">
                                ...
                                <div className="row mt-65">
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="card-why-travel card-love-us hover-up">
                                            <div className="card-image"> <img src="/assets/imgs/page/homepage2/policy.svg" alt="Wenago" /></div>
