                    ...
                    <div className="row align-items-end">
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                            <div className="card-support">
                                ...
                                <div className="card-image"> <img src="/assets/imgs/page/homepage3/support.png" alt="Wenago" /><img src="/assets/imgs/page/homepage3/support2.png" alt="Wenago" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-5 col-lg-4 wow fadeInUp">
                            <div className="card-image-promotion">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage3/img-travel.png" alt="Wenago" />
                                </div>
                                <div className="card-info">
