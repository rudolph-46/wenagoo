                            ...
                            <div className="col-lg-6">
                                <div className="box-item-download wow fadeInUp"> <span className="btn btn-brand-secondary">Install
                                    ...
                                    <h5 className="mt-15 mb-30">Up to 55% Discount<br className="d-none d-lg-block" />and lots of
                                        special gifts</h5>
                                    <div className="box-button-download"> <Link href="#"><img src="/assets/imgs/page/homepage6/googleplay.png" alt="Wenago" /></Link><Link href="#"><img src="/assets/imgs/page/homepage6/appstore.png" alt="Wenago" /></Link>
                                    </div>
                                </div>
                            </div>
