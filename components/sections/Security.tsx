            ...
            <section className="section-box box-security background-body">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-4">
                            <div className="box-img-security wow fadeInUp"> <span className="text-phone">+01 235 368</span><img src="/assets/imgs/page/homepage6/man.png" alt="Wenago" /></div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card-why-travel card-love-us wow fadeInUp">
                            ...
                            <div className="card-why-travel card-love-us wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/repu.svg" alt="Wenago" /></div>
