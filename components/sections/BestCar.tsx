                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-30 wow fadeInUp">
                            <div className="box-image-3-col">
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car.png" alt="Wenago" /><img src="/assets/imgs/page/homepage8/best-car2.png" alt="Wenago" /></div>
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car3.png" alt="Wenago" /><img src="/assets/imgs/page/homepage8/best-car4.png" alt="Wenago" /></div>
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car5.png" alt="Wenago" /><img src="/assets/imgs/page/homepage8/best-car6.png" alt="Wenago" /></div>
                            </div>
                        </div>
