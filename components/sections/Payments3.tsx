					...
					<div className="row align-items-center">
						...
						<div className="col-lg-5 mb-30 text-center text-lg-end wow fadeInUp">
							<div className="box-video-payment">
								<div className="dot-payment"> <img src="/assets/imgs/page/homepage4/dot-payment.png" alt="Wenago" /></div>
								<div className="img-sm-payment"> <img src="/assets/imgs/page/homepage4/img-payment-sm.png" alt="Wenago" /></div>
								<div className="review-payment"> <img className="light-mode" src="/assets/imgs/page/homepage4/img-review.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage4/img-review-dark.png" alt="Wenago" /></div>
								<div className="card-video">
									<div className="card-image">
										<VideoPopup vdocls="btn btn-play popup-youtube" />
										<img src="/assets/imgs/page/homepage4/img-payment.png" alt="Wenago" /></div>
								</div>
							</div>
						</div>
					</div>
