                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="/rental-detail"><img src="/assets/imgs/page/homepage8/service.png" alt="Wenago" /></Link></div>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="/rental-detail"><img src="/assets/imgs/page/homepage8/service2.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="/rental-detail"><img src="/assets/imgs/page/homepage8/service3.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="/rental-detail"><img src="/assets/imgs/page/homepage8/service4.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
