                        ...
                        <div className="row">
                            <div className="col-xl-8 col-lg-8 col-md-12">
                                <div className="card-spot card-spot-2 background-card">
                                    <div className="card-image">
                                        <label className="lbl-promotion">26 promotions</label><Link href="/destination"><img src="/assets/imgs/page/homepage6/trend.png" alt="Wenago" /></Link>
                                    </div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="card-spot card-spot-2 background-card wow fadeInUp">
                                    <div className="card-image"> <Link href="/destination"><img src="/assets/imgs/page/homepage6/trend2.png" alt="Wenago" /></Link></div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="card-spot card-spot-2 background-card wow fadeInUp">
                                    <div className="card-image"> <Link href="/destination"><img src="/assets/imgs/page/homepage6/trend3.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="card-spot card-spot-2 background-card wow fadeInUp">
                                    <div className="card-image"> <Link href="/destination"><img src="/assets/imgs/page/homepage6/trend4.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="card-spot card-spot-2 background-card wow fadeInUp">
                                    <div className="card-image"> <Link href="/destination"><img src="/assets/imgs/page/homepage6/trend5.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
