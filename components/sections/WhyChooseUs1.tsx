                            ...
                            <div className="row">
                                <div className="col-sm-6 mt-35">
                                    <div className="card-why-choose-us">
                                        <div className="card-image"> <img src="/assets/imgs/page/homepage1/destination.png" alt="Wenago" /></div>
                                ...
                                <div className="col-sm-6">
                                    <div className="card-why-choose-us background-body">
                                        <div className="card-image"> <img src="/assets/imgs/page/homepage1/support.png" alt="Wenago" /></div>
                                        <div className="card-info">
