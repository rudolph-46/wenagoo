                                ...
                                <Swiper {...swiperGroup4}>
                                    <SwiperSlide>
                                        <div className="card-spot background-card wow fadeInDown">
                                            <div className="card-image"> <Link href="/rental-property-2"><img src="/assets/imgs/page/homepage9/area.png" alt="Wenago" /></Link></div>
                                    ...
                                    <SwiperSlide>
                                        <div className="card-spot background-card wow fadeInDown">
                                            <div className="card-image"> <Link href="/rental-property-2"><img src="/assets/imgs/page/homepage9/area2.png" alt="Wenago" /></Link></div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
                                    ...
                                    <SwiperSlide>
                                        <div className="card-spot background-card wow fadeInDown">
                                            <div className="card-image"> <Link href="/rental-property-2"><img src="/assets/imgs/page/homepage9/area3.png" alt="Wenago" /></Link></div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
                                    ...
                                    <SwiperSlide>
                                        <div className="card-spot background-card wow fadeInDown">
                                            <div className="card-image"> <Link href="/rental-property-2"><img src="/assets/imgs/page/homepage9/area4.png" alt="Wenago" /></Link></div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
