		...
		<>
			...
			<section className="box-section block-banner-9 box-banner-home5-search background-body">
				<div className="block-banner-9-inner">
					...
					<div className="image-banner-bottom"> <img src="/assets/imgs/page/homepage9/banner-sm.png" alt="Wenago" />
					</div>
					<div className="image-banner-top-left"> <img src="/assets/imgs/page/homepage9/banner-sm2.png" alt="Wenago" />
					</div>
					<div className="block-right-banner" style={{ backgroundImage: 'url(assets/imgs/page/homepage9/banner.png)' }}>
						<div className="item-support border-1 background-body"> <img className="light-mode" src="/assets/imgs/page/homepage9/support.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage9/support-dark.png" alt="Wenago" />
						...
						<div className="item-people-used">
							<div className="box-authors-partner background-body wow fadeInUp">
								...
								<div className="authors-partner-right">
									<p className="text-sm neutral-1000">1684 people used <strong>Wenago </strong>in the last
