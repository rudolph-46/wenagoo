                ...
                <div className="container">
                    <div className="row align-items-end">
                        <div className="col-md-9 mb-30">
                            ...
                            <h6 className="heading-6-medium neutral-400">Discover the World's Treasures with Wenago </h6>
                        </div>
                                ...
                                <SwiperSlide>
                                    <div className="card-journey-big background-card">
                                        <div className="card-image"> <Link className="wish" href="#">
                                            ...
                                            </svg></Link><img src="/assets/imgs/page/homepage1/journey1.png" alt="Wenago" />
                                        </div>
