        ...
        <>
            ...
            <section className="section-box block-why-choose-us background-body">
                <div className="container">
                    <div className="bg-why shape-1 wow fadeInUp"> <img className="light-mode" src="/assets/imgs/page/homepage9/bg-dot.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage9/bg-dot-dark.png" alt="Wenago" /></div>
                    <div className="bg-why-2 shape-2 wow fadeInUp"><img className="light-mode" src="/assets/imgs/page/homepage9/bg-dot-2.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage9/bg-dot-2-dark.png" alt="Wenago" /></div>
                        ...
                        <div className="box-why-home9-inner-inner">
                            ...
                            <div className="box-list-why wow fadeInUp">
                                <div className="card-why-travel card-love-us wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/support.svg" alt="Wenago" /></div>
                                ...
                                <div className="card-why-travel card-love-us card-margin-left wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/repu.svg" alt="Wenago" />
                                    </div>
                                ...
                                <div className="card-why-travel card-love-us wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/security.svg" alt="Wenago" /></div>
