                        ...
                        <div className="row">
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top2.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top3.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top4.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top5.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top6.png" alt="Wenago" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top7.png" alt="Wenago" />
                                    </div>
