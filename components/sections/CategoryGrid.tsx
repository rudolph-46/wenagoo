                            ...
                            <div className="card-category card-category-3 wow fadeInUp" style={{ backgroundImage: 'url(assets/imgs/page/homepage5/explore.png)' }}>
                                ...
                                <div className="card-info">
                                    <div className="card-text">
                                        ...
                                        <div className="box-img-activity"><img src="/assets/imgs/page/homepage5/img-explore.png" alt="Wenago" /></div><Link className="btn btn-brand-secondary" href="#">View More
                                            <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8 15L15 8L8 1M15 8L1 8" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                            </svg></Link>
