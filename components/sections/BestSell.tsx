                            ...
                            <div className="box-list-flights">
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/logo1.png" alt="Wenago" />
                                            <div className="flight-info">
                                                <p className="text-md-bold neutral-1000">New York (JFK)</p>
                                                <p className="text-sm-medium time-flight">
                                                    {" "}
                                                    <span className="neutral-1000">20:00</span>- 05 Jan 2026
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/tokyo.png" alt="Wenago" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/sydney.png" alt="Wenago" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/dubai.png" alt="Wenago" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/los.png" alt="Wenago" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage10/paris.png" alt="Wenago" />
                                            <div className="flight-info">
                                        ...
                                        <div className="flight-name">
                                            <div className="flight-info">
                                                ...
                                                <p className="text-sm-medium time-flight">
                                                    {" "}
                                                    <span className="neutral-1000">14:00</span>- 06 Jan 2026
                                                </p>
                                            </div>
                                        </div>
                                    </div>
