                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot.png" alt="Wenago" /></Link></div>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot2.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot3.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot4.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot5.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot6.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot7.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
                                <div className="card-spot background-card">
                                    <div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage4/spot8.png" alt="Wenago" /></Link></div>
                                    <div className="card-info background-card">
                                        <div className="card-left">
