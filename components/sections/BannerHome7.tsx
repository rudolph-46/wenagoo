				...
				<div className="box-banner-home8">
					<div className="container">
						<div className="block-banner-home8">
							...
							<div className="box-image-banner-home8"><img src="/assets/imgs/page/homepage8/car.png" alt="Wenago" /><span className="dot-banner"><img src="/assets/imgs/page/homepage8/dot.png" alt="Wenago" /></span></div>
						</div>
					</div>
				</div>
				<div className="container">
