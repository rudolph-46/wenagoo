                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5">
                            <div className="row">
                                <div className="col-md-7 mb-30"><img className="bdrd8 w-100" src="/assets/imgs/page/homepage1/pay1.png" alt="Wenago" /></div>
                                <div className="col-md-5 mb-30"><img className="bdrd8 w-100 mb-15" src="/assets/imgs/page/homepage1/pay2.png" alt="Wenago" /><img className="bdrd8 w-100" src="/assets/imgs/page/homepage1/pay3.png" alt="Wenago" /></div>
                            </div>
                        </div>
