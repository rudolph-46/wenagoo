		...
		<>
			...
			<section className="section-box box-banner-home4 background-body">
				...
				<div className="container">
					...
					<div className="box-image-banner-home4"><img src="/assets/imgs/page/homepage4/banner.png" alt="Wenago" />
						<div className="shape-rate"> <img className="light-mode" src="/assets/imgs/page/homepage4/review.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage4/review-dark.png" alt="Wenago" /></div>
						<div className="shape-phone"><img className="light-mode" src="/assets/imgs/page/homepage4/hotline.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage4/hotline-dark.png" alt="Wenago" /></div>
					</div>
				</div>
			</section>
		</>
