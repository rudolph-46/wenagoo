                    ...
                    <div className="row mt-60 align-items-center">
                        <div className="col-lg-6 wow fadeInUp">
                            <div className="box-image-how">
                                <div className="image-top-how"> <img src="/assets/imgs/page/homepage4/img-how.png" alt="Wenago" />
                                </div>
                                <div className="image-bottom-how"> <img src="/assets/imgs/page/homepage4/img-how2.png" alt="Wenago" /><img src="/assets/imgs/page/homepage4/img-how3.png" alt="Wenago" />
                                    <div className="shape"> <img className="light-mode" src="/assets/imgs/page/homepage4/wave.png" alt="Wenago" /><img className="dark-mode" src="/assets/imgs/page/homepage4/wave-dark.png" alt="Wenago" /></div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="card-why-travel card-why-travel-2 background-1 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/security.svg" alt="Wenago" />
                                </div>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-2 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/support.svg" alt="Wenago" />
                                </div>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-3 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/policy.svg" alt="Wenago" />
                                </div>
