								...
								<SwiperSlide>
									<div className="item-banner-box">
										<div className="item-banner-box-inner"> <span className="btn btn-brand-secondary">Luxury
											...
											<div className="download-apps"> <Link href="#"><img src="/assets/imgs/template/googleplay.png" alt="Wenago" /></Link><Link href="#"><img src="/assets/imgs/template/appstore.png" alt="Wenago" /></Link>
											</div>
										</div>
									</div>
								</SwiperSlide>
