                    ...
                    <div className="row">
                        <div className="col-lg-6 mb-30">
                            <div className="card-banner">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/banner1.png" alt="Wenago" />
                                </div>
                        ...
                        <div className="col-lg-6 mb-30">
                            <div className="card-banner">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/banner2.png" alt="Wenago" />
                                </div>
                                <div className="card-info">
