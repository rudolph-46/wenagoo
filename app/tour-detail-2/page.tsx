                                ...
                                <div className="container-banner">
                                    ...
                                    <div className="slider-thumnail">
                                        <Slider {...settingsThumbs} ref={slider2} className="slider-nav-thumbnails">
                                            <div className="banner-slide">
                                                <img src="/assets/imgs/page/tour-detail/banner-thumb.png" alt="Wenago" />
                                            </div>
                                            <div className="banner-slide">
                                                <img src="/assets/imgs/page/tour-detail/banner-thumb2.png" alt="Wenago" />
                                            </div>
                                            <div className="banner-slide">
                                                <img src="/assets/imgs/page/tour-detail/banner-thumb3.png" alt="Wenago" />
                                            </div>
                                            <div className="banner-slide">
                                                <img src="/assets/imgs/page/tour-detail/banner-thumb2.png" alt="Wenago" />
                                            </div>
