...
import type { RoomTypeDetail } from "@/lib/ota";
...
export default function RoomDetailClient({ room }: { room: RoomTypeDetail }) {
    ...
    const photos = room.photoUrls.length > 0 ? room.photoUrls : [FALLBACK];
                    ...
                    <section className="box-section box-breadcrumb background-body">
                        <div className="container">
                            <ul className="breadcrumbs">
                                ...
                                <li>
                                    {" "}
                                    <Link href="/hotel-grid">Hôtels</Link>
                                    <span className="arrow-right">
                                        <svg width={7} height={12} viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 11L6 6L1 1" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                        </svg>
                                                        ...
                                                        <div className="col-lg-6">
                                                            ...
                                                            <ul>
                                                                {room.amenities.length > 0 ? room.amenities.map((a, i) => (
                                                                    <li key={i}>{a}</li>
                                                                )) : <li>Aucun équipement renseigné</li>}
                                                            </ul>
                                                        </div>
                                                        <div className="col-lg-6">
