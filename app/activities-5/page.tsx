...
export default function Activities5() {
    const { filter, sortCriteria, itemsPerPage, currentPage, uniqueActivities, uniqueLanguages, uniqueAttractions, uniqueRatings, sortedTours, totalPages, paginatedTours, handleCheckboxChange, handleSortChange, handlePriceRangeChange, handleDurationRangeChange, handleItemsPerPageChange, handlePageChange, handlePreviousPage, handleNextPage, handleClearFilters, startItemIndex, endItemIndex } = useTourFilter(toursData);
                                ...
                                <div className="row">
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination.png" alt="Wenago" />
                                            </div>
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination2.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination3.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination4.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination5.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination6.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination7.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="card-popular card-top-destination background-card wow fadeInUp">
                                            <div className="card-image">
                                                {" "}
                                                <img src="/assets/imgs/page/homepage6/destination8.png" alt="Wenago" />
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                <Link className="card-title" href="#">
                            ...
                            <div className="box-content-main">
                                <div className="content-right">
                                    <div className="box-filters mb-25 pb-5 border-bottom border-1">
                                        <SortToursFilter sortCriteria={sortCriteria} handleSortChange={handleSortChange} itemsPerPage={itemsPerPage} handleItemsPerPageChange={handleItemsPerPageChange} handleClearFilters={handleClearFilters} startItemIndex={startItemIndex} endItemIndex={endItemIndex} sortedTours={sortedTours} />
                                    </div>
                                                    ...
                                                    <div className="pt-0">
                                                        <div className="box-input-date">
                                                            <div className="input-calendar">
                                                                ...
                                                                <input className="form-control calendar-date" type="text" defaultValue="17/02/2026" />
                                    ...
                                    <div className="sidebar-left border-1 background-body">
                                        <div className="box-filters-sidebar">
                                            <div className="block-filter border-1">
                                                ...
                                                <ByActivities uniqueActivities={uniqueActivities} filter={filter} handleCheckboxChange={handleCheckboxChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="sidebar-left border-1 background-body">
                                        <div className="box-filters-sidebar">
                                            <div className="block-filter border-1">
                                                ...
                                                <ByAttraction uniqueAttractions={uniqueAttractions} filter={filter} handleCheckboxChange={handleCheckboxChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="sidebar-left border-1 background-body">
                                        <div className="box-filters-sidebar">
                                            <div className="block-filter border-1">
                                                ...
                                                <ByDuration filter={filter} handleDurationRangeChange={handleDurationRangeChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="sidebar-left border-1 background-body">
                                    ...
                                    <div className="sidebar-left border-1 background-body">
                                        <div className="box-filters-sidebar">
                                            <div className="block-filter border-1">
                                                ...
                                                <ByLanguage uniqueLanguages={uniqueLanguages} filter={filter} handleCheckboxChange={handleCheckboxChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="sidebar-left border-1 background-body">
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/tour/post.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/tour/post2.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/tour/post3.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/tour/post4.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/tour/post5.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
