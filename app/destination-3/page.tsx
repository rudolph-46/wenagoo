										...
										<div className="col-lg-6 col-sm-6">
											<div className="card-video card-video-type-2">
												<div className="card-image">
													...
													<img src="/assets/imgs/page/homepage6/payment.png" alt="Wenago" /></div>
											</div>
											<div className="card-video card-video-type-2">
												<div className="card-image"><img src="/assets/imgs/page/homepage6/payment3.png" alt="Wenago" /></div>
											</div>
										</div>
										<div className="col-lg-6 col-sm-6 box-image-payment-right">
											<div className="card-video card-video-type-2">
												<div className="card-image"><img src="/assets/imgs/page/homepage6/payment2.png" alt="Wenago" /></div>
											</div>
											<div className="card-video card-video-type-2">
												<div className="card-image"><img src="/assets/imgs/page/homepage6/payment4.png" alt="Wenago" /></div>
											</div>
										</div>
									</div>
								</div>
