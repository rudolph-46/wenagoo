                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 mb-30">
                                    ...
                                    <h6 className="neutral-500">Discover the World's Treasures with Wenago </h6>
                                </div>
                                <div className="col-lg-6 mb-30">
                                            ...
                                            <Swiper {...swiperGroup5}>
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity.png" alt="Wenago" />
                                                        </div>
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity2.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity3.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity4.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity5.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity6.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity7.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                                ...
                                                <SwiperSlide>
                                                    <div className="card-popular-destination card-popular-destination-type-2">
                                                        <div className="card-image">
                                                            {" "}
                                                            <img src="/assets/imgs/page/homepage5/activity8.png" alt="Wenago" />
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-sm-bold" href="#">
                                    ...
                                    <Swiper {...swiperGroupCenter4}>
                                        <SwiperSlide>
                                            <div className="card-blog">
                                                <div className="card-image">
                                                    <img src="/assets/imgs/page/blog/blog.png" alt="Wenago" />
                                                </div>
                                                <div className="card-info">
                                                    <div className="card-info-blog">
                                                        <Link className="btn btn-label-tag" href="/blog-grid-2">
                                                            Cultural
                                                        </Link>
                                                        <Link className="card-title heading-5" href="/blog-detail">
                                                            Savoring Life’s Palette: Art, Food, and Beyond
                                                        </Link>
                                                        <div className="card-meta-user">
                                                            <div className="box-author-small">
                                                                {" "}
                                                                <img src="/assets/imgs/page/homepage1/avatar.png" alt="Travilla" />
                                                                <p className="text-sm-bold">By Jimmy Dave</p>
                                                            </div>
                                                            <div className="date-post">
                                                                <p className="text-sm-medium">12 January 2026</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <SwiperSlide>
                                            <div className="card-blog">
                                                <div className="card-image">
                                                    <img src="/assets/imgs/page/blog/blog2.png" alt="Wenago" />
                                                </div>
                                                <div className="card-info">
                                                    <div className="card-info-blog">
                                                        <Link className="btn btn-label-tag" href="/blog-grid-2">
                                        ...
                                        <SwiperSlide>
                                            <div className="card-blog">
                                                <div className="card-image">
                                                    <img src="/assets/imgs/page/blog/blog3.png" alt="Wenago" />
                                                </div>
                                                <div className="card-info">
                                                    <div className="card-info-blog">
                                                        <Link className="btn btn-label-tag" href="/blog-grid-2">
                                        ...
                                        <SwiperSlide>
                                            <div className="card-blog">
                                                <div className="card-image">
                                                    <img src="/assets/imgs/page/blog/blog4.png" alt="Wenago" />
                                                </div>
                                                <div className="card-info">
                                                    <div className="card-info-blog">
                                    ...
                                    <div className="box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn">
                                        <div className="card-flight card-news background-card">
                                            <div className="card-image">
                                                ...
                                                <Link href="/blog-detail">
                                                    <img src="/assets/imgs/page/blog/news.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                ...
                                                <div className="card-title">
                                                    {" "}
                                                    <Link className="heading-6 neutral-1000" href="/blog-detail">
                                                        The Art of Living: A Stylish Tech Odyssey
                                                    </Link>
                                                </div>
                                                <div className="card-meta">
                                                    {" "}
                                                    <span className="post-date neutral-1000">18 Sep 2026</span>
                                        ...
                                        <div className="card-flight card-news background-card">
                                            <div className="card-image">
                                                ...
                                                <Link href="/blog-detail">
                                                    <img src="/assets/imgs/page/blog/news2.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                        ...
                                        <div className="card-flight card-news background-card">
                                            <div className="card-image">
                                                ...
                                                <Link href="/blog-detail">
                                                    <img src="/assets/imgs/page/blog/news3.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                        ...
                                        <div className="card-flight card-news background-card">
                                            <div className="card-image">
                                                ...
                                                <Link href="/blog-detail">
                                                    <img src="/assets/imgs/page/blog/news4.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info">
                                                {" "}
                                                ...
                                                <div className="card-title">
                                                    {" "}
                                                    <Link className="heading-6 neutral-1000" href="/blog-detail">
                                                        Tech Threads and Culinary Canvas: My Lifestyle Palette
                                                    </Link>
                                                </div>
                                                <div className="card-meta">
                                                    {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            {" "}
                                                            <Link href="/blog-detail">
                                                                <img src="/assets/imgs/page/blog/trending.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-md-bold neutral-1000" href="/blog-detail">
                                                                Beyond the Pixels: My Art-Tech Lifestyle Journey
                                                            </Link>
                                                            <p className="text-sm-medium date-post neutral-500">18 Sep 2026</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            {" "}
                                                            <Link href="/blog-detail">
                                                                <img src="/assets/imgs/page/blog/trending2.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            {" "}
                                                            <Link href="/blog-detail">
                                                                <img src="/assets/imgs/page/blog/trending3.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            {" "}
                                                            <Link href="/blog-detail">
                                                                <img src="/assets/imgs/page/blog/trending4.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            {" "}
                                                            <Link href="/blog-detail">
                                                                <img src="/assets/imgs/page/blog/trending5.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                        ...
                                        <div className="box-content-sidebar">
                                            <ul className="list-photo-col-3">
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat2.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat3.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat4.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat5.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat6.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat7.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <Link href="#">
                                                        <img src="/assets/imgs/page/blog/cat8.png" alt="Wenago" />
                                                    </Link>
                                                </li>
                                                <li>
                                                    {" "}
