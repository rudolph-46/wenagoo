                    ...
                    <section className="box-section box-breadcrumb background-body">
                        <div className="container">
                            <ul className="breadcrumbs">
                                ...
                                <li>
                                    {" "}
                                    <span className="text-breadcrumb">Globetrotting in Style: A Journey Through My Lens</span>
                                </li>
                            </ul>
                        </div>
                    </section>
                            ...
                            <div className="box-banner-single-blog">
                                ...
                                <div className="box-swiper">
                                    <div className="swiper-container swiper-group-1">
                                        <Swiper {...swiperGroup1}>
                                            <SwiperSlide>
                                                <img src="/assets/imgs/page/blog/banner-detail2.png" alt="Travile" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <img src="/assets/imgs/page/blog/banner-detail2.png" alt="Travile" />
                                            </SwiperSlide>
                                    ...
                                    <div className="box-content-detail-blog">
                                        <div className="box-content-info-detail mt-0 pt-0">
                                                ...
                                                <div className="meta-post">
                                                    <div className="meta-user justify-content-start">
                                                        ...
                                                        <div className="post-meta-date">
                                                            <div className="post-date neutral-1000">18 Sep 2026</div>
                                            ...
                                            <div className="box-image-video">
                                                {" "}
                                                <img className="bdrd8" src="/assets/imgs/page/blog/banner-detail3.png" alt="Travilla" />
                                                    ...
                                                    <div className="list-reviews">
                                                        ...
                                                        <div className="item-review">
                                                            <div className="head-review">
                                                                <div className="author-review">
                                                                    {" "}
                                                                    <img src="/assets/imgs/page/blog/avatar.png" alt="Wenago" />
                                                                    <div className="author-info">
                                                                        <p className="text-lg-bold">Sarah Johnson</p>
                                                                        <p className="text-sm-medium neutral-500">December 4, 2026 at 3:12 pm</p>
                                                                    </div>
                                                        ...
                                                        <div className="item-review">
                                                            <div className="head-review">
                                                                <div className="author-review">
                                                                    {" "}
                                                                    <img src="/assets/imgs/page/blog/avatar2.png" alt="Wenago" />
                                                                    <div className="author-info">
                                                                        <p className="text-lg-bold">Sarah Johnson</p>
                                                                        <p className="text-sm-medium neutral-500">December 4, 2026 at 3:12 pm</p>
                                                                    </div>
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        ...
                                                        <div className="card-info">
                                                            {" "}
                                                            <Link className="text-md-bold neutral-1000" href="/blog-detail-2">
                                            ...
                                            <SwiperSlide>
                                                <div className="card-news background-card hover-up">
                                                    <div className="card-image">
                                                        ...
                                                        <img src="/assets/imgs/page/homepage1/news.png" alt="Wenago" />
                                                    </div>
                                                    <div className="card-info">
                                                        ...
                                                        <div className="card-title">
                                                            {" "}
                                                            <Link className="text-xl-bold neutral-1000" href="/blog-detail-2">
                                                        ...
                                                        <div className="card-program">
                                                            <div className="endtime">
                                                                <div className="card-author">
                                                                    {" "}
                                                                    <img src="/assets/imgs/page/homepage1/avatar.png" alt="Wenago" />
                                                                    <p className="text-sm-bold neutral-1000">Jimmy Dave</p>
                                                                </div>
                                                                <div className="card-button">
                                                                    {" "}
                                                                    <Link className="btn btn-gray" href="/blog-detail-2">
                                                                        Keep Reading
                                                                    </Link>
                                                                </div>
                                                            </div>
                                            ...
                                            <SwiperSlide>
                                                <div className="card-news background-card hover-up">
                                                    <div className="card-image">
                                                        ...
                                                        <img src="/assets/imgs/page/homepage1/news2.png" alt="Wenago" />
                                                    </div>
                                                    <div className="card-info">
                                                        <div className="card-meta">
                                                            {" "}
                                            ...
                                            <SwiperSlide>
                                                <div className="card-news background-card hover-up">
                                                    <div className="card-image">
                                                        ...
                                                        <img src="/assets/imgs/page/homepage1/news3.png" alt="Wenago" />
                                                    </div>
                                                    <div className="card-info">
                                                        <div className="card-meta">
                                                            {" "}
