                            ...
                            <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-sm-6">
                                            <div className="banner-detail-1">
                                                {" "}
                                                <img src="/assets/imgs/page/tour-detail/banner.png" alt="Travile" />
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-sm-6">
                                            <div className="banner-detail-2">
                                                {" "}
                                                <img src="/assets/imgs/page/tour-detail/banner2.png" alt="Travile" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-4 col-lg-12">
                                    <div className="banner-detail-3">
                                        {" "}
                                        <img src="/assets/imgs/page/tour-detail/banner3.png" alt="Travile" />
                                    </div>
                                </div>
                                <div className="col-xl-4 col-lg-12">
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="banner-detail-4">
                                                {" "}
                                                <img src="/assets/imgs/page/tour-detail/banner4.png" alt="Travile" />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="banner-detail-5">
                                                {" "}
                                                <img src="/assets/imgs/page/tour-detail/banner5.png" alt="Travile" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="banner-detail-6">
                                        {" "}
                                        <img src="/assets/imgs/page/tour-detail/banner6.png" alt="Travile" />
                                    </div>
                                </div>
                            </div>
                        </div>
