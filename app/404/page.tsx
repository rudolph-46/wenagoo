                    ...
                    <section className="section-box box-become-video background-body">
                        <div className="container">
                            <div className="text-center">
                                {" "}
                                <img className="mr-10" src="/assets/imgs/page/pages/404.png" alt="Travile" />
                                <h1 className="neutral-1000">
                                    {" "}
                                    <span>We </span>Can’t Find <span>This Page</span>
                                </h1>
                                <p className="text-xl-medium neutral-500">The page you are looking for doesn’t exist or has been moved.</p>
                                    ...
                                    <div className="card-contact">
                                        ...
                                        <div className="card-info">
                                            <div className="card-title">
                                                ...
                                                <p className="text-xs-medium neutral-500">Communicate your problems with the community</p>
                                            </div>
                                    ...
                                    <div className="card-contact">
                                        ...
                                        <div className="card-info">
                                            <div className="card-title">
                                                ...
                                                <p className="text-xs-medium neutral-500">Dive in to learn all about Wenago Platform</p>
                                            </div>
                                            <div className="card-method-contact">
                                                {" "}
                                                <Link className="email text-md-bold" href="#">
