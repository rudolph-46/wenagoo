					...
					<section className="box-section block-banner-tourlist" style={{ backgroundImage: 'url(assets/imgs/page/destination/banner.png)' }}>
						<div className="container">
							<div className="text-center">
								<h3>Explore the beauty of Europe with Wenago</h3>
								...
								<div className="row">
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot.png" alt="Wenago" /></Link></div>
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot2.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot3.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot4.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot5.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot6.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot7.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="/destination-4"><img src="/assets/imgs/page/homepage4/spot8.png" alt="Wenago" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-lg-4 col-md-6 wow fadeIn">
										<div className="card-journey-small background-card">
											<div className="card-image"> <Link className="label" href="#">Top Rated</Link><Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><img src="/assets/imgs/page/homepage1/journey2.png" alt="Wenago" />
											</div>
											<div className="card-info background-card">
												<div className="card-rating">
													<div className="card-left"> </div>
									...
									<div className="col-lg-4 col-md-6 wow fadeIn">
										<div className="card-journey-small background-card">
											<div className="card-image"> <Link className="label bestsale" href="#">Best Sale</Link><Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><img src="/assets/imgs/page/homepage1/journey3.png" alt="Wenago" />
											</div>
											<div className="card-info background-card">
												<div className="card-rating">
													<div className="card-left"> </div>
									...
									<div className="col-lg-4 col-md-6 wow fadeIn">
										<div className="card-journey-small background-card">
											<div className="card-image"> <Link className="label saleoff" href="#">25% Off</Link><Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><img src="/assets/imgs/page/homepage1/journey4.png" alt="Wenago" />
											</div>
											<div className="card-info background-card">
												<div className="card-rating">
													<div className="card-left"> </div>
							...
							<div className="row align-items-center">
								<div className="col-lg-6 mb-30 wow fadeInUp">
									<div className="box-image-sky">
										<div className="col-sky-1"><img className="w-100" src="/assets/imgs/page/homepage10/sky.png" alt="Wenago" /><img className="w-100" src="/assets/imgs/page/homepage10/sky2.png" alt="Wenago" /></div>
										<div className="col-sky-2"><img className="w-100" src="/assets/imgs/page/homepage10/sky3.png" alt="Wenago" /></div>
									</div>
								</div>
								<div className="col-lg-6 mb-30 wow fadeInUp">
