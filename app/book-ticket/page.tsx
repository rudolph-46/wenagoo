                ...
                <main className="main">
                    ...
                    <section className="section-box block-banner-book-tickets background-card">
                        <div className="container">
                            <div className="box-image-book">
                                {" "}
                                <img src="/assets/imgs/page/tickets/banner-booking.png" alt="Wenago" />
                                <Link className="btn-logo" href="#">
                                    <img src="/assets/imgs/page/tickets/cathay.png" alt="Wenago" />
                                </Link>
                            </div>
                        </div>
                    </section>
                    <section className="section-box block-content-book-tickets background-card">
                        <div className="container">
                            ...
                            <p className="text-md-medium neutral-1000">Embark on a seamless journey with Cathay Pacific from New York (JFK) to Tokyo (NRT), with a layover in vibrant Hong Kong (HKG). Enjoy world-class service, comfortable seating, and delicious dining options onboard. Take advantage of your layover to explore the dynamic city of Hong Kong before continuing your adventure to Tokyo. With Cathay Pacific, every flight promises an exceptional experience from start to finish.</p>
                                    ...
                                    <div className="box-content-tickets-detail">
                                        <div className="box-timeline">
                                            <div className="item-timeline">
                                                {" "}
                                                <span className="text-xl-bold text-ads-middle">16h 0m</span>
                                                <div className="item-line-timeline">
                                                    <div className="time-flight">
                                                        <p className="text-sm-bold neutral-1000 icon-time">13:50</p>
                                                        <p className="text-sm-medium neutral-500">05 Jan 2026</p>
                                                    </div>
                                                    <div className="location-flight">
                                                        <p className="text-xl-bold neutral-1000 mb-5">New York (JFK)</p>
                                                        <p className="text-sm-medium neutral-500">John F Kennedy Intl Terminal 8</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="item-timeline">
                                                <div className="item-line-timeline">
                                                    ...
                                                    <div className="location-flight">
                                                        <p className="text-xl-bold neutral-1000">Hong Kong (HKG)</p>
                                                        <p className="text-sm-medium neutral-500">Hong Kong International Airport Terminal 1</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="box-stop">
                                            <div className="box-stop-left">
                                                <Link className="close-stop" href="#">
                                                    <img src="/assets/imgs/page/tickets/close-stop.png" alt="Wenago" />
                                                </Link>
                                            </div>
