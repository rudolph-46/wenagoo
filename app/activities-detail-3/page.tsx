                        ...
                        <div className="container position-relative">
                            <div className="container-banner-activities">
                                <div className="box-button-abs box-button-abs-right">
                                    ...
                                    <VideoPopup vdocls="btn btn-white-md popup-youtube" style2 notext />
                                </div>
                            </div>
                            <div className="banne-activities-3">
                                <div className="banner-col-1">
                                    {" "}
                                    <img src="/assets/imgs/page/activities/banner2.png" alt="Wenago" />
                                </div>
                                <div className="banner-col-2">
                                    {" "}
                                    <img src="/assets/imgs/page/activities/banner3.png" alt="Wenago" />
                                </div>
                                <div className="banner-col-3">
                                    {" "}
                                    <img src="/assets/imgs/page/activities/banner4.png" alt="Wenago" />
                                </div>
                            </div>
                        </div>
                        <div className="container">
