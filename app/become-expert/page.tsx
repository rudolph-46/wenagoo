		...
		<>
			...
			<Layout headerStyle={1} footerStyle={1}>
				<main className="main">
								...
								<div className="row">
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/earth.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/tour.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/custom.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/car.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/local.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/themed.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/ride.png" alt="Wenago" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/visas.png" alt="Wenago" /></div>
					...
					<section className="section-box box-why-book-wenago-3 background-body">
						<div className="container">
							<div className="text-center">
							...
							<div className="block-install-apps">
								<div className="row align-items-center">
									<div className="col-lg-6 mb-40 wow fadeInLeft"><span className="btn btn-tag">Install APP   Get  discount code</span>
										...
										<p className="text-xl-medium neutral-500">Embark on a journey like never before with Wenago – your ultimate travel companion.</p>
