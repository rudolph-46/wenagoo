                    ...
                    <section className="box-section box-breadcrumb background-body">
                        <div className="container">
                            <ul className="breadcrumbs">
                                ...
                                <li>
                                    {" "}
                                    <span className="text-breadcrumb">The High Roller Experience: Tickets for The LINQ Observation Wheel, Las Vegas Strip</span>
                                </li>
                            </ul>
                        </div>
                    </section>
                            ...
                            <div className="row">
                                    ...
                                    <div className="box-banner-tour-detail-3">
                                        <div className="box-swiper">
                                            <div className="swiper-container swiper-group-1">
                                                <Swiper {...swiperGroup1}>
                                                    <SwiperSlide>
                                                        <img src="/assets/imgs/page/tour-detail/banner-detail.png" alt="Travile" />
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <img src="/assets/imgs/page/tour-detail/banner-detail.png" alt="Travile" />
                                                    </SwiperSlide>
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="sidebar-banner">
                                        {" "}
                                        <Link href="#">
                                            <img src="/assets/imgs/page/tour-detail/banner-ads.png" alt="Wenago" />
                                        </Link>
                                    </div>
                                    <div className="sidebar-banner">
                                        {" "}
                                        <Link href="#">
                                            <img src="/assets/imgs/page/tour-detail/banner-ads2.png" alt="Wenago" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
