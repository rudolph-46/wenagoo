                                ...
                                <div className="box-banner-activities">
                                    <Slider {...settingsMain} ref={slider1} className="banner-activities-detail">
                                        <div className="banner-slide-activity">
                                            <img src="/assets/imgs/page/car/banner2.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide-activity">
                                            <img src="/assets/imgs/page/car/banner2.png" alt="Wenago" />
                                        </div>
                                ...
                                <div className="slider-thumnail-activities">
                                    <Slider {...settingsThumbs} ref={slider2} className="slider-nav-thumbnails-activities-detail">
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn2.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn3.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn4.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn5.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn6.png" alt="Wenago" />
                                        </div>
                                        <div className="banner-slide">
                                            <img src="/assets/imgs/page/car/banner-thumn.png" alt="Wenago" />
                                        </div>
                            ...
                            <div className="row mt-30">
                                        ...
                                        <div className="list-feature-car">
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/km.png" alt="Wenago" />
                                                    </div>
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/diesel.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/auto.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/seat.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/bag.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/suv.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/door.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                            ...
                                            <div className="item-feature-car">
                                                <div className="item-feature-car-inner">
                                                    <div className="feature-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/car/lit.png" alt="Wenago" />
                                                    </div>
                                                    <div className="feature-info">
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="sidebar-banner">
                                        {" "}
                                        <Link href="#">
                                            <img src="/assets/imgs/page/car/banner-ads.png" alt="Wenago" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <div className="box-image-how wow fadeInUp">
                                        {" "}
                                        <img src="/assets/imgs/page/homepage8/img-how.png" alt="Wenago" />
                                        <span className="img-arrow">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage8/img-arrow.png" alt="Wenago" />
                                        </span>
                                        <span className="img-dot">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage8/dot-img.png" alt="Wenago" />
                                        </span>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    ...
                                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                        <div className="card-spot background-card">
                                            <div className="card-image">
                                                {" "}
                                                <Link href="#">
                                                    <img src="/assets/imgs/page/homepage8/service.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                    ...
                                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                        <div className="card-spot background-card">
                                            <div className="card-image">
                                                {" "}
                                                <Link href="#">
                                                    <img src="/assets/imgs/page/homepage8/service2.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
                                    ...
                                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                        <div className="card-spot background-card">
                                            <div className="card-image">
                                                {" "}
                                                <Link href="#">
                                                    <img src="/assets/imgs/page/homepage8/service3.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
                                    ...
                                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
                                        <div className="card-spot background-card">
                                            <div className="card-image">
                                                {" "}
                                                <Link href="#">
                                                    <img src="/assets/imgs/page/homepage8/service4.png" alt="Wenago" />
                                                </Link>
                                            </div>
                                            <div className="card-info background-card">
                                                <div className="card-left">
