                        ...
                        <div className="container">
                            <div className="box-mw-824">
                                <div className="text-center">
                                    ...
                                    <p className="text-xl-medium neutral-1000 mb-55 wow fadeInUp">Last update: Mar 17, 2026</p>
                                </div>
                            </div>
                            <div className="box-image-video mb-45">
                                {" "}
                                <img className="bdrd-16" src="/assets/imgs/page/pages/banner-privacy.png" alt="Travilla" />
                            </div>
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p>At Wenago, we take your privacy seriously and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you use our website or services.</p>
                                    <p>
                                        {" "}
                                        <strong>Information Collection: </strong>We may collect personal information such as your name, contact details, payment information, and browsing activity when you interact with our website or make a reservation.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Use of Information: </strong>We use the information collected to process your bookings, provide customer support, improve our services, and communicate with you about promotions or updates.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Disclosure of Information:</strong>We may share your information with third-party service providers, business partners, or affiliates for purposes such as payment processing, customer service, or marketing activities.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Data Security: </strong>We implement security measures to protect your information from unauthorized access, disclosure, alteration, or destruction.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Cookies: </strong>We may use cookies and similar technologies to enhance your browsing experience, analyze website traffic, and personalize content and advertisements.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Third-Party Links: </strong>Our website may contain links to third-party websites or services. We are not responsible for the privacy practices or content of these websites.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Children's Privacy: </strong>Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children without parental consent.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Changes to Privacy Policy: </strong>We reserve the right to update or modify this Privacy Policy at any time. Any changes will be effective immediately upon posting on our website.
                                    </p>
                                    <p>If you have any questions or concerns about our Privacy Policy or the handling of your personal information, please contact us at contact@wenago.com.</p>
                                ...
                                <div className="box-share-us">
                                    ...
                                    <p className="text-lg-bold neutral-1000">Wenago Team</p>
                                </div>
                            </div>
                        </div>
                    </section>
