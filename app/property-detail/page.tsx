                ...
                <main className="main">
                                ...
                                <div className="row">
                                    <div className="col-xl-6 col-lg-6">
                                        <div className="banner-property-detail-1">
                                            {" "}
                                            <img src="/assets/imgs/page/property/banner2.png" alt="Travile" />
                                    ...
                                    <div className="col-xl-3 col-lg-3 col-sm-6">
                                        <div className="banner-property-detail-2">
                                            {" "}
                                            <img src="/assets/imgs/page/property/banner3.png" alt="Travile" />
                                        </div>
                                        <div className="banner-property-detail-3">
                                            {" "}
                                            <img src="/assets/imgs/page/property/banner4.png" alt="Travile" />
                                        </div>
                                    </div>
                                    <div className="col-xl-3 col-lg-3 col-sm-6">
                                        <div className="banner-property-detail-4">
                                            {" "}
                                            <img src="/assets/imgs/page/property/banner5.png" alt="Travile" />
                                        </div>
                                        <div className="banner-property-detail-5">
                                            {" "}
                                            <img src="/assets/imgs/page/property/banner6.png" alt="Travile" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container-fluid">
                            <div className="box-button-faq wow fadeInRight">
                                ...
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/airport.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/airport-w.svg" alt="Travile" />
                                    Airport Transfer
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/safety-box.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/safety-box-w.svg" alt="Travile" />
                                    Safety Box
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/coffee-shop.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/coffee-shop-w.svg" alt="Travile" />
                                    Balcony
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/massage.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/massage-w.svg" alt="Travile" />
                                    Spa Sauna
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/animal.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/animal-w.svg" alt="Travile" />
                                    Pet Allowed
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/wifi.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/wifi-w.svg" alt="Travile" />
                                    Free Wifi
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/hairdryer.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/hairdryer-w.svg" alt="Travile" />
                                    Air Dryer
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/air-conditioner.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/air-conditioner-w.svg" alt="Travile" />
                                    Air Condition
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/loundry.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/loundry-w.svg" alt="Travile" />
                                    Loundry Service
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/bed.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/bed-w.svg" alt="Travile" />
                                    King Size Bed
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/food.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/food-w.svg" alt="Travile" />
                                    Front desk
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                    <img className="light-mode" src="/assets/imgs/page/room/living.svg" alt="Travile" />
                                    <img className="dark-mode" src="/assets/imgs/page/room/living-w.svg" alt="Travile" />
                                    Living Area
                                </Link>
                                <Link className="btn btn-border-1" href="#">
                                    {" "}
                                                        ...
                                                        <div className="item-review">
                                                            <div className="head-review">
                                                                <div className="author-review">
                                                                    {" "}
                                                                    <img src="/assets/imgs/page/tour-detail/avatar.png" alt="Wenago" />
                                                                    <div className="author-info">
                                                                        <p className="text-lg-bold">Sarah Johnson</p>
                                                                        <p className="text-sm-medium neutral-500">December 4, 2026 at 3:12 pm</p>
                                                                    </div>
                                                                </div>
                                                                <div className="rate-review">
                                                                    {" "}
                                                                    <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="Wenago" />
                                                                    <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="Wenago" />
                                                                    <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="Wenago" />
                                                                    <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="Wenago" />
                                                                    <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="Wenago" />
                                            ...
                                            <div className="box-agent-support">
                                                <div className="card-author">
                                                    <div className="card-author-image">
                                                        {" "}
                                                        <img src="/assets/imgs/page/property/author.png" alt="Wenago" />
                                                    </div>
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/property/feature.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            ...
                                                            <span className="price text-sm-bold neutral-1000">$48.25</span>
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/property/feature2.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/property/feature3.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/property/feature4.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                                ...
                                                <li>
                                                    <div className="card-post">
                                                        <div className="card-image">
                                                            ...
                                                            <Link href="#">
                                                                {" "}
                                                                <img src="/assets/imgs/page/property/feature5.png" alt="Wenago" />
                                                            </Link>
                                                        </div>
                                                        <div className="card-info">
                                                            {" "}
                                ...
                                <div className="col-lg-4 col-md-6 wow fadeInUp">
                                    <div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
                                        <div className="card-image">
                                            ...
                                            <img src="/assets/imgs/page/property/like.png" alt="Wenago" />
                                        </div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6 wow fadeInUp">
                                    <div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
                                        <div className="card-image">
                                            ...
                                            <img src="/assets/imgs/page/property/like2.png" alt="Wenago" />
                                        </div>
                                        <div className="card-info">
                                            <div className="card-rating">
                                                <div className="card-left"> </div>
                                ...
                                <div className="col-lg-4 col-md-6 wow fadeInUp">
                                    <div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
                                        <div className="card-image">
                                            ...
                                            <img src="/assets/imgs/page/property/like3.png" alt="Wenago" />
                                        </div>
                                        <div className="card-info">
                                            <div className="card-rating">
                                                <div className="card-left"> </div>
                    ...
                    <section className="section-box box-media background-body">
                        <div className="container-media wow fadeInUp">
                            {" "}
                            <img src="/assets/imgs/page/homepage5/media.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media2.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media3.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media4.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media5.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media6.png" alt="Wenago" />
                            <img src="/assets/imgs/page/homepage5/media7.png" alt="Wenago" />
                        </div>
                    </section>
                </main>
            </Layout>
