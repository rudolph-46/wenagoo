                        ...
                        <div className="container">
                            ...
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p className="neutral-1000">Welcome to Wenago! Before you begin using our platform, please take a moment to review the terms and conditions that govern your use of our website and services.</p>
                                    <p>
                                        {" "}
                                        <strong>Acceptance of Terms:</strong>By accessing and using our platform, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions. If you do not agree with these terms, please do not use our services.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>User Accounts:</strong>To use our platform, you must create a user account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Subscription Plans: </strong>We offer various subscription plans for our services, each with different features and prices. You can select the plan that best fits your needs and preferences.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Payment:</strong>Payment for subscription plans is due at the beginning of each billing cycle. We accept various payment methods, including credit card and PayPal.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Intellectual Property:</strong>All intellectual property rights in our platform, including software, content, and trademarks, are owned by us or our licensors. You may not copy, modify, distribute, or sell any part of our platform without our prior written consent.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Limitation of Liability:</strong>We will not be liable for any damages arising out of or in connection with the use of our platform, including but not limited to direct, indirect, incidental, or consequential damages.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Termination:</strong>We reserve the right to terminate or suspend your access to our platform at any time, without prior notice, if you violate these terms and conditions or engage in any unlawful or unauthorized activity.
                                    </p>
                                    <p>
                                        {" "}
                                        <strong>Changes to Terms:</strong>We may update or modify these terms and conditions at any time, without prior notice. Your continued use of our platform after such changes will constitute your acceptance of the revised terms.
                                    </p>
